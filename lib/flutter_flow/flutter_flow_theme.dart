...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFC9F0FF);
  ...
  late Color columbiaBlue = const Color(0xFFC9F0FF);
  late Color azureWeb = const Color(0xFFEAFFFD);
  late Color antiflashWhite = const Color(0xFFEFEFF0);
  late Color thistle = const Color(0xFFD5CAD6);
  late Color wenge = const Color(0xFF6B5E62);
