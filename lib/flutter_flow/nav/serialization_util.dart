    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case AnnouncementListRow:
            return AnnouncementListRow(data);
          case TournamentListRow:
            return TournamentListRow(data);
          case EventWithVouchersRow:
            return EventWithVouchersRow(data);
          case PaddedMidViewRow:
            return PaddedMidViewRow(data);
          case VouchersRow:
