                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Text(
                                                'Prefer using phone number instead?',
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    'Di mana anda dengar mengenai chess.my?',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium,
                                                  ),
                                          ...
                                          if (!functions.isValidEmail(_model
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  content: Text(
                                                      '${!functions.isValidEmail(_model.emailAddressController.text)! ? 'Invalid email! ' : ' '}${!functions.isValidNoKP(_model.icController.text)! ? 'Invalid IC No.! ' : ' '}${(_model.namaController.text == '') || (functions.checkStringLength(_model.namaController.text)! < 5) ? 'Invalid name! ' : ' '}'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
