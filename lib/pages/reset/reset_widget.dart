...
class _ResetWidgetState extends State<ResetWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.param = await actions.getAccessToken(
        currentJwtToken,
      );
    });
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Text(
                    'Reset password for $currentUserEmail',
                    style: FlutterFlowTheme.of(context).bodyMedium,
                  ),
                ),
                Padding(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.updateResult =
                            await actions.updateSupabasePassword(
                          _model.password1Controller.text,
                        );
                        shouldSetState = true;
                        if (_model.updateResult!) {
                          await showDialog(
                            context: context,
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: const Text('Update berjaya!'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: const Text('Update TIDAK berjaya.'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                                        Navigator.pop(alertDialogContext),
